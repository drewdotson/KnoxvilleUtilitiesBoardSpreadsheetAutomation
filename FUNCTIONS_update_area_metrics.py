...
# The purpose of this file is to contain the functions used for the update_area_metrics file.

import FUNCTIONS_time_checks
import copy
...
# sheet name as input.
def create_area_dict(sheet_name):
    ...
    first_row = sheet_name.first_valid_index()
    last_row = sheet_name.last_valid_index()
...
def merge_sheet_dicts(main_sheet, archive_sheet):
    ...
    main_areas = create_area_dict(main_sheet)
    archive_areas = create_area_dict(archive_sheet)
...
def add_start_to_complete_times_dict(times_dict, sheet_name):
    ...
    for row in sheet_name[first_row:last_row + 1].itertuples():
        ...
        job_time = FUNCTIONS_time_checks.start_to_complete_time_check(row)
...
# as inputs.
def add_call811_to_mark811_times_dict(times_dict, sheet_name):
    ...
    for row in sheet_name[first_row:last_row + 1].itertuples():
        ...
        mark811_time = FUNCTIONS_time_checks.call811_to_mark811_time_check(row)
...
# name as inputs.
def add_mark811_to_complete_times_dict(times_dict, sheet_name):
    ...
    for row in sheet_name[first_row:last_row + 1].itertuples():
        ...
        complete_post_mark_time = FUNCTIONS_time_checks.mark811_to_complete_time_check(row)
