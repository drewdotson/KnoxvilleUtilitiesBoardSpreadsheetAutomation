...
# The purpose of this file is to contain the functions used for the update_month_metrics file.
...
# as input.
def create_month_year_dict(sheet_name):
    ...
    for row in sheet_name[sheet_name.first_valid_index():sheet_name.last_valid_index() + 1].itertuples():
...
def merge_and_sort_sheet_dicts(main_sheet, archive_sheet):
    ...
    main_months = create_month_year_dict(main_sheet)
    archive_months = create_month_year_dict(archive_sheet)
